...
public interface ProjectService {
	...
	// 두 프로젝트를 연결
	void connectProjects(Long userId, Long currentProjectId, Long nextProjectId);
	...
	// 프로젝트 내용 수정
	void updateProject(Long userId, Long projectId, String content);

	// 프로젝트 완료
	void completeProject(Long userId, Long projectId);
