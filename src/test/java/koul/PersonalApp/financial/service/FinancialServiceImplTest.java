...
class FinancialServiceImplTest {
        ...
        void addFinanceRecord_Success() {
                // given
                Long userId = 1L;
                FinancialRecordCommand command = new FinancialRecordCommand("맥북 프로", 3500000L, "전자기기");
        ...
        void getRecentFinanceRecord_Success() {
                ...
                List<FinancialRecord> records = List.of(
                                FinancialRecord.builder().description("커피").amount(5000L).category("식비")
                                                .financial(financial).build(),
                                FinancialRecord.builder().description("점심").amount(10000L).category("식비")
                                                .financial(financial).build());
